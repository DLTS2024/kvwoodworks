<?php
/**
 * Wooden Works Category Template
...
$categories = [
    'vasakal' => ['title' => 'Vasakal (Main Doors)', 'icon' => 'door-open'],
    'window-janal' => ['title' => 'Window & Janal Designs', 'icon' => 'window-maximize'],
    'wooden-staircase' => ['title' => 'Wooden Staircase Designs', 'icon' => 'stairs']
];

$categoryInfo = $categories[$slug] ?? ['title' => ucwords(str_replace('-', ' ', $slug)), 'icon' => 'tree'];
$pageTitle = $categoryInfo['title'];
$pageDescription = 'Explore our stunning ' . strtolower($categoryInfo['title']) . ' crafted with premium wood.';
...
<section class="page-header">
    <div class="container">
        ...
        <p>Explore our stunning <?php echo strtolower($categoryInfo['title']); ?> crafted with premium wood</p>
...
<script>
    ...
    function openExploreModal(designId) {
        ...
        document.getElementById('modalDescription').innerHTML = design.description || 'This beautiful wooden design showcases premium craftsmanship and traditional aesthetics.';
...
<section class="cta">
    <div class="container">
        <div class="cta-content">
            <h2>Ready to Order Your <?php echo str_replace(' Designs', '', $categoryInfo['title']); ?>?</h2>
